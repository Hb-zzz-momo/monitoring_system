            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  // AI Work Order Suggestion Widget
                  AIWorkOrderSuggestion(
                    deviceName: workOrder['device'],
                    alarmType: workOrder['title'],
                    componentName: workOrder['component'],
                    additionalContext: workOrder['description'],
                  ),
                  // Checklist
                  Padding(
